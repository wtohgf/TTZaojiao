//
//  TTWoGrowTestReportShengaoCellTableViewCell.m
//  TTzaojiao
//
...
@implementation TTWoGrowTestReportShengaoCellTableViewCell
...
+ (instancetype)WoGrowTestReportShengaoCellWithTabelView:(UITableView *)tableView
{
    ...
    TTWoGrowTestReportShengaoCellTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID ];
    if (nil == cell) {
        cell = [[TTWoGrowTestReportShengaoCellTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
...
- (void)layoutSubviews{
    ...
    {
        [_descLabel setFrame:CGRectMake(8, _modelFrame.nianlingPicHeight+30, _modelFrame.shengaonianlingFrame.size.width,_modelFrame.shengaonianlingFrame.size.height) ];
    }
