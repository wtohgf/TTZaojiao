...
- (LamaTableViewCellModelFrame *)modelFrame
{
    if (_modelFrame == nil) {
        ...
        modelFrame.PicListAndContentCellHeight = 200;
        ...
        modelFrame.i_pic_listFrame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 100);
        modelFrame.i_contentFrame = CGRectMake(0, 100, [UIScreen mainScreen].bounds.size.width, 100);
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    {
        LamaTableViewCellPicListAndContent *cell = [LamaTableViewCellPicListAndContent LamaTableViewCellPicListAndContentWithTabelView:_tableView];
        //数据传给cell，由cell处理设置
        cell.modelFrame = _modelFrame;
        return cell;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //return self.modelFrame.cellHeight;
    if (indexPath == 0 ) {
    ...
    {
        return self.modelFrame.PicListAndContentCellHeight;
    }
